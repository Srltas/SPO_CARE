...
public class KyungpookMapViewActivity extends Activity implements MapView.POIItemEventListener, MapView.MapViewEventListener {
    MapPOIItem marker;
    MapView mapView;
    MapPoint markerPoint = MapPoint.mapPointWithGeoCoord(35.864233, 128.601639);

    private static final String TAG = "KyungpookMapViewActivity";

    @Override
    protected void onCreate(Bundle saveInstanceState){
        super.onCreate(saveInstanceState);
        setContentView(R.layout.kyungpook_map);
