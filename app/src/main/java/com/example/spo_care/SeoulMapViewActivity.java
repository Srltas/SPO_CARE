...
public class SeoulMapViewActivity extends Activity implements MapView.POIItemEventListener, MapView.MapViewEventListener {
    MapPOIItem marker;
    MapView mapView;
    MapPoint markerPoint = MapPoint.mapPointWithGeoCoord(37.577715, 126.999662);

    private static final String TAG = "SeoulMapViewActivity";
