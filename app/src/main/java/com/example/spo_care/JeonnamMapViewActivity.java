...
public class JeonnamMapViewActivity extends Activity implements MapView.POIItemEventListener, MapView.MapViewEventListener {
    MapPOIItem marker;
    MapView mapView;
    MapPoint markerPoint = MapPoint.mapPointWithGeoCoord(35.172352, 126.900654);

    private static final String TAG = "JeonnamMapViewActivity";

    @Override
    protected void onCreate(Bundle saveInstanceState){
        super.onCreate(saveInstanceState);
        setContentView(R.layout.jeonnam_map);
