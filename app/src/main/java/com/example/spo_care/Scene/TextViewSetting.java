...
public class TextViewSetting extends android.support.v7.widget.AppCompatTextView {
    ...
    public TextViewSetting(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (parentHeight == 0)
            parentHeight = height;
        //this.setMeasuredDimension(parentWidth, parentHeight); //이것때무네 높이가 이상해짐.
    }
